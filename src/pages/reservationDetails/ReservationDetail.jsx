...
const ReservationDetail = ({ setIsOpenModal, date, time, partySize,  }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        if (!phoneError && phoneNumber && firstName && lastName && email && occasion) {
            setCloseModal1(true);
        } else {
            setPhoneError('Пожалуйста, исправьте ошибки в форме');
        }
    };
        ...
        <>
            ...
            <div className="flex gap-10 justify-center mr-auto">
                <div>
                    ...
                    <section className="flex flex-col gap-6 mt-[46px]">
                        <input
                            className="w-[475px] h-[100px] rounded-xl bg-[#F6F6F6] text-xl font-normal pl-4 ml-[57px]"
                            type="text"
                        ...
                        <textarea
                            className="w-[475px] h-[325px] rounded-xl bg-[#F6F6F6] text-xl font-normal p-4 resize-none ml-[57px]"
                        ...
                        <div className="flex gap-[20px] mb-[115px]">
                            <input type="radio" className="w-[44px] h-[44px] ml-[50px]" />
                            <p className="text-xl font-normal text-[#5C4529] w-[523px] h-[60px]">
                                Sign me up to receive dining offers and news <br /> from this restaurant by email.
                            </p>
                        </div>
