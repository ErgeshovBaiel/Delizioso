...
const ReservationConfirm = ({ date, time, partySize }) => {
    const navigate = useNavigate();
    ...
    const handleModifyClick = () => {
        // When the "Modify" button is clicked, we navigate to the Reservation page to modify details
        navigate("/reservation", {
            state: { date, time, partySize }
        });
    };
    ...
    return (
        <div className="app-container">
            ...
            <div className="flex items-center">
                ...
                <div className="flex flex-col gap-4 mt-[60px] ml-[112px]">
                    <button
                        className="w-[246px] h-[80px] bg-[#9ecaff] rounded-[20px] text-center flex items-center justify-center text-blue-900"
