      ...
      <div className='app-container relative top-25 flex gap-45'>
        <div>
          ...
          <h1 className='mt-18 w-[288px] h-[176px] text-[#311F09] text-[80px] font-[Raleway]  font-bold leading-[11%]'>
            Italian <span className='relative top-20'>Cuisine</span>
          </h1>
          ...
          <div className='flex gap-6 mt-25'>
            <div className='mt-25x w-[232.42px] h-[74.44px] rounded-full bg-[#FF8A00]'>
              <button className='w-[228px] h-[42px] text-[20px]  pt-4.25 text-white font-[Poppins] font-semibold leading-[200%]'>
                Order now
              </button>
            </div>
            <div className='w-[233px] h-[75px] rounded-full bg-[#3FA72F]'>
              <button className='w-[122px] h-[42px] text-[20px] text-white pl-13.75 pt-4.25 font-[Poppins] font-semibold leading-[200%]'>
                Reservation
              </button>
            </div>
          </div>
