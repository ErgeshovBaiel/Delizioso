...
export default function Category () {
  ...
  const handleOrderClick = food => {
    ...
    // Update the order status in localStorage for the selected category
  ...
  const handleCartClick = () => {
    setOrderStatus({})
    const allOrderStatus = JSON.parse(localStorage.getItem('orderStatus')) || {}
    delete allOrderStatus[selectedCategory] // Remove the order status for the selected category
    localStorage.setItem('orderStatus', JSON.stringify(allOrderStatus))
  }
